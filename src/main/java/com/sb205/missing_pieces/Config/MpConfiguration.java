...
public class MpConfiguration {
    ...
    public  enum ConfigInfo {
		...
		MISC_PADDED_SPINDLE("PaddedSpindle",CATEGORY_NAME_MISC,		ModType.MOD_MISSING_PIECES,	MISC_DEFAULT_VALUE),
		...
		CHAIR_STRAIGHT_OAK("oak_straight_chair",	CATEGORY_NAME_CHAIRS,	ModType.MOD_MISSING_PIECES,	CHAIR_DEFAULT_VALUE),
		CHAIR_PADDED_OAK("oak_padded_chair",		CATEGORY_NAME_CHAIRS,	ModType.MOD_MISSING_PIECES,	CHAIR_DEFAULT_VALUE),
		CHAIR_ADIRONDACK_OAK("oak_adirondack_chair",CATEGORY_NAME_CHAIRS,	ModType.MOD_MISSING_PIECES,	CHAIR_DEFAULT_VALUE),
    	// natura Woods
		...
		WEDGE_OBSIDIAN("obsidian_wedge",		CATEGORY_NAME_WEDGES,	ModType.MOD_MISSING_PIECES,	WEDGE_DEFAULT_VALUE),
		...
		WEDGE_P_DIORITE("p_diorite_wedge",		CATEGORY_NAME_WEDGES,	ModType.MOD_MISSING_PIECES,	WEDGE_DEFAULT_VALUE),
